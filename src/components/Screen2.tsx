    ...
    <div className="flex  bg-gray-100">
      ...
      <ul>
        {appointments.map((appointment, index) => (
          <li key={index} className="flex items-center py-3 border-b last:border-b-0">
            <div className="bg-black/30  rounded-full mr-2 w-7 h-7 flex justify-center items-center">
            <Play  size={20} />
            </div>
            <div className="flex-grow px-2">
              <div className="flex justify-between items-center">
                <span className="font-medium text-black/80">{appointment.name} - {appointment.time}</span>
                <div className="flex items-center">
                  <MoreVertical className="text-black mr-10" size={20} />
                  <UserPlus className="text-black" size={20} />
                </div>
              </div>
              <span className="text-sm text-gray-500">{appointment.vehicle}</span>
            </div>
          </li>
        ))}
      </ul>
            ...
            <div className="w-6/12  flex flex-col gap-7">
              <section>
                <p className="font-medium text-black/80 text-lg mb-4">Job Status Tracking</p>
                <section className="flex justify-between gap-7">
                    ...
                    <p className="text-black font-medium text-xl"><span className="text-3xl">3</span> Waiting</p>
                    </div>
                    <div className="bg-blue-200 border-blue-400 border rounded-full flex justify-center items-center w-4/12 h-20">
                    <p className="text-black font-medium text-xl"><span className="text-3xl">5</span> In Servive</p>
                    </div>
                    <div className="bg-blue-200 border-blue-400 border rounded-full flex justify-center items-center w-4/12 h-20">
                    <p className="text-black font-medium text-xl"><span className="text-3xl">10</span> Completed</p>
                    </div>
                </section>
              </section>
